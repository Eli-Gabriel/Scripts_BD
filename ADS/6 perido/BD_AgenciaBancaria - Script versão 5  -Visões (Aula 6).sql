...
-  A ordem das informações solicitadas em cada questão deve ser mantida na consulta;
-  Personalize os resultados com AS;
-  Não mostre códigos de chaves estrangeiras nas suas consultas.
-  Identifique cada exercícios com comentário. Exemplo: #exercicio01
- Crie os comandos após a última tabela do Script;
